...
use PE\Component\CacheFile\Resource\DirectoryResource;
...
class DirectoryResourceTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->directory = sys_get_temp_dir().DIRECTORY_SEPARATOR.'directoryIterator';
    ...
    public function testSerializeUnserialize()
    {
        ...
        $this->assertEquals($unserialized, $resource);
    }
